...
ode = @ODEmodel(
    ...
    C2'(t) = kp(t)*C1(t) - (koff)*C2(t),
    kp'(t) = 0,
    y1(t) = koff/kon + (T*(C0(t)+C1(t)+C2(t))/2),
    y2(t) = kp(t)
)
...
ode = @ODEmodel(
    ...
    C3'(t) = kp(t)*C2(t) - (koff)*C3(t),
    kp'(t) = 0,
    y1(t) = koff/kon + (T*(C0(t)+C1(t)+C2(t)+C3(t))/2),
    y2(t) = kp(t)
)
...
ode = @ODEmodel(
    ...
    C4'(t) = kp(t)*C3(t) - (koff)*C4(t),
    kp'(t) = 0,
    y1(t) = koff/kon + (T*(C0(t)+C1(t)+C2(t)+C3(t)+C4(t))/2),
    y2(t) = kp(t)
)
...
ode = @ODEmodel(
    ...
    C5'(t) = kp(t)*C4(t) - (koff)*C5(t),
    kp'(t) = 0,
    y1(t) = koff/kon + (T*(C0(t)+C1(t)+C2(t)+C3(t)+C4(t)+C5(t))/2),
    y2(t) = kp(t)
)
