...
ode = @ODEmodel(
    ...
    C3'(t) = (r^2)*kp*C2(t) - ((4/(1 + 3*r))*koff + (r^3)*kp)*C3(t),
    C4'(t) = (r^3)*kp*C3(t) - ((5/(1 + 4*r))*koff)*C4(t),
    y1(t) = ((1 + (4 * koff * (6 * koff^2 + kp^2 * (1 + 3 * r + 2 * r^2) * rp^3 * (2 + rp) + koff * kp * rp * (3 + 5 * rp + r * (3 + 7 * rp)))) / (kp^3 * (1 + r) * (1 + 2 * r) * (1 + 3 * r) * rp^5)) ) * (T(t) + C0(t) + C1(t) + C2(t) + C3(t) + C4(t))
)
...
ode = @ODEmodel(
    ...
    C2'(t) = rp*kp*C1(t) - ((3/(1 + 2*r))*koff + (rp^2)*kp)*C2(t),
    C3'(t) = (3/(1 + 2*r))*kp*C2(t) - (4/(1 + 3*r))*koff*C3(t),
    y1(t) = ((1 + (4 * koff * (6 * koff^2 + kp^2 * (1 + 3 * r + 2 * r^2) * rp^3 * (2 + rp) + koff * kp * rp * (3 + 5 * rp + r * (3 + 7 * rp)))) / (kp^3 * (1 + r) * (1 + 2 * r) * (1 + 3 * r) * rp^5)) ) * (T(t) + C0(t) + C1(t) + C2(t) + C3(t))
)
