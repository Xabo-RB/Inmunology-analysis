...
ode = @ODEmodel(
    ...
    y1(t) = (T(t) + C0(t) + C1(t) + C2(t))/2 + (koff + kp)/kon * (3*koff / (kp * rp * (2*r + 1)) * (2*koff / (r + 1) + rp) * (1 + 3*koff / (kp * rp * (2*r + 1)) * (1 + 2*koff / (kp * (r + 1)) + rp)))
)
...
ode = @ODEmodel(
    ...
    y2(t) = kon(t),
    y3(t) = kp(t),
    y4(t) = (T(t) + C0(t) + C1(t) + C2(t))/2 + (koff + kp(t))/kon(t) * (3*koff / (kp(t) * rp * (2*r + 1)) * (2*koff / (r + 1) + rp) * (1 + 3*koff / (kp(t) * rp * (2*r + 1)) * (1 + 2*koff / (kp(t) * (r + 1)) + rp)))
)
...
ode = @ODEmodel(
    ...
    C2'(t) = rp*kp*C1(t) - (3/(1 + 2*r))*koff*C2(t),
    kon'(t) = 0,
    y1(t) = (T(t) + C0(t) + C1(t) + C2(t))/2 + (koff + kp)/kon(t) * (3*koff / (kp * rp * (2*r + 1)) * (2*koff / (r + 1) + rp) * (1 + 3*koff / (kp * rp * (2*r + 1)) * (1 + 2*koff / (kp * (r + 1)) + rp))),
    y2(t) = kon(t)
)
...
ode = @ODEmodel(
    ...
    C2'(t) = rp*kp(t)*C1(t) - (3/(1 + 2*r))*koff*C2(t),
    kp'(t) = 0,
    y1(t) = (T(t) + C0(t) + C1(t) + C2(t))/2 + (koff + kp(t))/kon * (3*koff / (kp(t) * rp * (2*r + 1)) * (2*koff / (r + 1) + rp) * (1 + 3*koff / (kp(t) * rp * (2*r + 1)) * (1 + 2*koff / (kp(t) * (r + 1)) + rp))),
    y2(t) = kp(t)
)
