...
ode = @ODEmodel(
    ...
    C1'(t) = kp * C0(t) - ((2 / (1 + r)) * koff + rp * kp) * C1(t),
    C2'(t) = rp * kp * C1(t) - ((3 / (1 + 2 * r)) * koff + (rp^2) * kp) * C2(t),
    C3'(t) = (rp^2) * kp * C2(t) - ((4 / (1 + 3 * r)) * koff + (rp^3) * kp) * C3(t),
    C4'(t) = (rp^3) * kp * C3(t) - ((5 / (1 + 4 * r)) * koff) * C4(t),
    y1(t) = C4(t)
)
...
ode = @ODEmodel(
    ...
    C2'(t) = rp * kp * C1(t) - ((3 / (1 + 2 * r)) * koff + (rp^2) * kp) * C2(t),
    C3'(t) = (rp^2) * kp * C2(t) - ((4 / (1 + 3 * r)) * koff + (rp^3) * kp) * C3(t),
    C4'(t) = (rp^3) * kp * C3(t) - ((5 / (1 + 4 * r)) * koff + (rp^4) * kp) * C4(t),
    C5'(t) = (rp^4) * kp * C4(t) - (6 / (1 + 5 * r)) * koff * C5(t),
    y1(t) = C5(t)
)
...
ode = @ODEmodel(
    ...
    C0'(t) = kon(t) * P(t) * T(t) - (koff + kp(t)) * C0(t),
    C1'(t) = kp(t) * C0(t) - ((2 / (1 + r)) * koff + rp * kp(t)) * C1(t),
    C2'(t) = rp * kp(t) * C1(t) - ((3 / (1 + 2 * r)) * koff + (rp^2) * kp(t)) * C2(t),
...
ode = @ODEmodel(
    ...
    C1'(t) = kp(t) * C0(t) - ((2 / (1 + r)) * koff + rp * kp(t)) * C1(t),
    C2'(t) = rp * kp(t) * C1(t) - ((3 / (1 + 2 * r)) * koff + (rp^2) * kp(t)) * C2(t),
    C3'(t) = (rp^2) * kp(t) * C2(t) - ((4 / (1 + 3 * r)) * koff + (rp^3) * kp(t)) * C3(t),
    C4'(t) = (rp^3) * kp(t) * C3(t) - ((5 / (1 + 4 * r)) * koff) * C4(t),
    kon'(t) = 0,
    kp'(t) = 0,
    y1(t) = C4(t),
    y2(t) = T(t),
...
ode = @ODEmodel(
    ...
    C2'(t) = rp * kp(t) * C1(t) - ((3 / (1 + 2 * r)) * koff + (rp^2) * kp(t)) * C2(t),
    C3'(t) = (rp^2) * kp(t) * C2(t) - ((4 / (1 + 3 * r)) * koff + (rp^3) * kp(t)) * C3(t),
    C4'(t) = (rp^3) * kp(t) * C3(t) - ((5 / (1 + 4 * r)) * koff + (rp^4) * kp(t)) * C4(t),
    C5'(t) = (rp^4) * kp(t) * C4(t) - (6 / (1 + 5 * r)) * koff * C5(t),
    kon'(t) = 0,
    kp'(t) = 0,
    y1(t) = C5(t),
    y2(t) = T(t),
...
ode = @ODEmodel(
    ...
    C0'(t) = kon * P(t) * T(t) - (koff + kp) * C0(t),
    C1'(t) = kp * C0(t) - ((2 / (1 + r)) * koff + rp * kp) * C1(t),
    C2'(t) = rp * kp * C1(t) - ((3 / (1 + 2 * r)) * koff + (r * r) * kp) * C2(t),
    C3'(t) = (rp^2) * kp * C2(t) - ((4 / (1 + 3 * r)) * koff + (rp^3) * kp) * C3(t),
    C4'(t) = (rp^3) * kp * C3(t) - ((5 / (1 + 4 * r)) * koff) * C4(t),
    y1(t) = C4(t),
    y2(t) = T(t)
...
# __________ kon T ________________________________________________________
# -------------------  N = 2 -------------------
ode = @ODEmodel(
    #dPdt (pMHC) / dTdt (TCR) / dC0/dt (1º pMHC-TCR)
    P'(t) = -kon(t) * P(t) * T(t) + koff * C0(t) + (2 / (1 + r)) * koff * C1(t) + (3 / (1 + 2 * r)) * koff * C2(t),
...
# __________ kp T ________________________________________________________
# -------------------  N = 2 -------------------
ode = @ODEmodel(
    #dPdt (pMHC) / dTdt (TCR) / dC0/dt (1º pMHC-TCR)
    P'(t) = -kon * P(t) * T(t) + koff * C0(t) + (2 / (1 + r)) * koff * C1(t) + (3 / (1 + 2 * r)) * koff * C2(t),
