...
# __________ sin T(t) ________________________________________________________
# -------------------  N = 2 -------------------
ode = @ODEmodel(
    #dPdt (pMHC) / dTdt (TCR) / dC0/dt (1º pMHC-TCR)
    P'(t) = -kon(t) * P(t) * T(t) + koff * C0(t) + lambdaR * (koff / (koff + rho1)) * C1(t) + lambdaR * (koff / (koff + rho2)) * C2(t),
...
# __________ CONOCIENDO Kon y R ________________________________________________________
# -------------------  N = 2 -------------------
ode = @ODEmodel(
    #dPdt (pMHC) / dTdt (TCR) / dC0/dt (1º pMHC-TCR)
    P'(t) = -kon(t) * P(t) * T(t) + koff * C0(t) + lambdaR * (koff / (koff + rho1)) * C1(t) + lambdaR * (koff / (koff + rho2)) * C2(t),
