...
%% VALORES INICIALES INTEGRACIÓN DEL MODELO
    ...
    tspan = 0.0:0.05:50;
    % kon koff
    p = complex([5e-5, 0.01, 1, 0.09, 1000, 10000, 1000], 0);
...
% close(h);
% 
% save('KPR_IR_kon.mat','tspan','konVect','results_matrix');
% 
...
save('KPR_IR_kp.mat','tspan','kpVect','results_matrix');
