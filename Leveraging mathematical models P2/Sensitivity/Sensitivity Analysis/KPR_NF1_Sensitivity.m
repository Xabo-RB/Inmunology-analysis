...
%% VALORES INICIALES INTEGRACIÓN DEL MODELO
    ...
    tspan = 0.0:0.05:200;
    % kon koff
    p = complex([5e-5, 0.01, 1, 4.4e-4, 0.04, 1, 2e-4, 6e5], 0);
...
% % end
% % 
% % save('nf1_KOFF.mat','tspan','koffVect','results_matrix');
% % 
...
% close(h);
% 
% save('nf1_Kon.mat','tspan','konVect','results_matrix');
% 
...
% close(h);
% 
% save('nf1_Kp.mat','tspan','kpVect','results_matrix');
% 
% results_matrix1 = log10(abs(results_matrix));
% 
% fig = figure('Visible','off');
