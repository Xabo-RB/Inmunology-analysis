...
%% EC50
% EC50
h = [(2 * (C0 + C1 + C2) * k2 * k3 * ((C0 + C1 + C2) - (T + Tp + C0 + C1 + C2 +D)) * (kmenos1 + w)*(k1 * ((C0 + C1 + C2) - (T + Tp + C0 + C1 + C2 +D)) - kmenos1) - (C0 + C1 + C2)*w* ...
     (w / (kmenos1 + w))^N * (k2 * k3 *(kmenos1 * (-2 * (C0 + C1 + C2) + 2 * (T + Tp + C0 + C1 + C2 +D) + 1) + 2 * k1 * ((C0 + C1 + C2) - (T + Tp + C0 + C1 + C2 +D))^2) + ...
     (C0 + C1 + C2) * kmenos1 * k1 * (k3 + kmenos2))) / (2 * k2 * k3 * k1 * ((C0 + C1 + C2) - (T + Tp + C0 + C1 + C2 +D))^2 * (kmenos1 + w) - ...
     w * (w / (kmenos1 + w))^N * (k2 * k3 *(2 * k1 * ((C0 + C1 + C2) - (T + Tp + C0 + C1 + C2 +D))^2 + kmenos1) + (C0 + C1 + C2) * kmenos1 * k1 * (k3 + kmenos2)))];
