...
ode = @ODEmodel(
    ...
    y1(t) = (T(t)+C0(t)+C1(t)+C2(t)+C1a(t)+C2a(t))*kp*(kp/(kp + (koff/(koff+rho1))))/((koff/(koff+rho2))+(koff/(koff+rho1))*(kp+(koff/(koff+rho2))))
)
...
ode = @ODEmodel(
    ...
    kon'(t) = 0,
    kp'(t) = 0,
    y1(t) = (T(t)+C0(t)+C1(t)+C2(t)+C1a(t)+C2a(t))*kp(t)*(kp(t)/(kp(t) + (koff/(koff+rho1))))/((koff/(koff+rho2))+(koff/(koff+rho1))*(kp(t)+(koff/(koff+rho2)))),
    y2(t) = T(t),
    y3(t) = kon(t),
    y4(t) = kp(t)
)
...
ode = @ODEmodel(
    ...
    C1a'(t) = koff*C1(t) - (rho1 + lambdaR + kp)*C1a(t),
    C2a'(t) = kp*C1a(t) + koff*C2(t) - (rho2 + lambdaR)*C2a(t),  
    y1(t) = (koff/(koff+rho2))*(koff + kp)/(kon*((koff/(koff+rho2)) + ((koff/(koff+rho2))+kp)*(kp/(kp + (koff/(koff+rho1)))))) + (T(t)+C0(t)+C1(t)+C2(t)+C1a(t)+C2a(t))/2
)
...
ode = @ODEmodel(
    ...
    kon'(t) = 0,
    kp'(t) = 0,
    y1(t) = (koff/(koff+rho2))*(koff + kp(t))/(kon(t)*((koff/(koff+rho2)) + ((koff/(koff+rho2))+kp(t))*(kp(t)/(kp(t) + (koff/(koff+rho1)))))) + (T(t)+C0(t)+C1(t)+C2(t)+C1a(t)+C2a(t))/2,
    y2(t) = T(t),
    y3(t) = kon(t),
    y4(t) = kp(t)
)
...
ode = @ODEmodel(
    ...
    C2a'(t) = kp*C1a(t) + koff*C2(t) - (rho2 + lambdaR)*C2a(t),  
    kon'(t) = 0,
    y1(t) = (koff/(koff+rho2))*(koff + kp)/(kon(t)*((koff/(koff+rho2)) + ((koff/(koff+rho2))+kp)*(kp/(kp + (koff/(koff+rho1)))))) + (T(t)+C0(t)+C1(t)+C2(t)+C1a(t)+C2a(t))/2,
    y2(t) = kon(t)
)
...
ode = @ODEmodel(
    ...
    C2a'(t) = kp(t)*C1a(t) + koff*C2(t) - (rho2 + lambdaR)*C2a(t),  
    kp'(t) = 0,
    y1(t) = (koff/(koff+rho2))*(koff + kp(t))/(kon*((koff/(koff+rho2)) + ((koff/(koff+rho2))+kp(t))*(kp(t)/(kp(t) + (koff/(koff+rho1)))))) + (T(t)+C0(t)+C1(t)+C2(t)+C1a(t)+C2a(t))/2,
    y2(t) = kp(t)
)
